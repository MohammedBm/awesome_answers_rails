Rails.application.routes.draw do
  ...
  # /admin/dashboard
  #also note theat the res for controllers defined within the namespace will be expected to be in a folder with the same name as the `namespace which is `admin` in this case. So the dash_controller.rb must be located in a subfolder called ` admin` within `app/controllers`
  namespace :admin do
  ...
  root 'welcome#index' #this will give a helpr method root path that will take you to the home page which is `welcome#index` in our case
